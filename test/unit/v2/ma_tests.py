...
class TestGMAv2(unittest.TestCase):
    ...
    def test_create_unauthorized_field(self):
        ...
        """
        create_data = {'KEY_ID' : '1', 'KEY_MEMBER':'urn:publicid:IDN+mych+user+abrown', 'KEY_TYPE':'rsa-ssh', 'KEY_DESCRIPTION':'SSH key for user Arlene Brown.', 'KEY_PUBLIC':'ssh-rsa '}
        self._test_create(create_data, 'KEY', 'KEY_ID', 3)
